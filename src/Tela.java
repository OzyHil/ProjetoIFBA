...
public class Tela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BotaoRetornarMenu = new javax.swing.JLabel();
        ...
        jButton2.setBounds(360, 320, 80, 23);
        ...
        BotaoRetornarMenu.setText(" <--");
        BotaoRetornarMenu.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                BotaoRetornarMenuMouseClicked(evt);
            }
        });
        BotoesLaterais.add(BotaoRetornarMenu);
        BotaoRetornarMenu.setBounds(0, 36, 30, 30);
        ...
        BotaoConcluirCadastroTurma.setBounds(20, 430, 90, 30);
        ...
        BarraDocentesCadastrados1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BarraDocentesTelaEditarDiscplinasActionPerformed(evt);
            }
        });

        BarraAlunosCadastradosDisciplinas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BarraAlunosTelaEditarDisciplinasActionPerformed(evt);
            }
        });
        ...
        BarraAlunosCadastradosAlunos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BarraAlunosCadastradosActionPerformed(evt);
            }
        });
        ...
        BarraDocentesCadastrados.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BarraDocentesCadastradosActionPerformed(evt);
            }
        });
        ...
        BarraAlunosCadastradosTurmas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BarraAlunosCadastradosTurmasActionPerformed(evt);
            }
        });
        ...
        BotaoGerarRelatorioAlunos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotaoGerarRelatorioAlunosActionPerformed(evt);
            }
        });
        ...
        BotaoGerarRelatorioDocentes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotaoGerarRelatorioDocentesActionPerformed(evt);
            }
        });
    ...
    private void BotaoAcessarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoAcessarActionPerformed
        ...
        // imagem = new ImageIcon("/Imagem/pngwingcom.jpg");
        //BotaoRetornarMenu.setIcon(new ImageIcon(imagem.getImage().getScaledInstance(BotaoRetornarMenu.getWidth(), BotaoRetornarMenu.getHeight(), Image.SCALE_DEFAULT)));
    ...
    private void BotaoRetornarMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoRetornarMenuMouseClicked
        ColorirBotoes();

        if (PainelMenu.isVisible() == true) {
            LimparSubmenus();

        }
        if (SubmenuRemocao.isVisible() == true) {
            LimparSubmenus();

        }
        if (SubmenuCadastro.isVisible() == true) {
            LimparSubmenus();

        }
        if (SubmenuEdicao.isVisible() == true) {
            System.out.println("volte");
            LimparSubmenus();

        }
        if (SubmenuEditarDadosDaDisciplina.isVisible() == true) {
            System.out.println("seu corno");
            LimparSubmenus();
            SubmenuEdicao.setVisible(true);

        }
        if (SubmenuRelatorio.isVisible() == true) {
            LimparSubmenus();

        }

    }//GEN-LAST:event_BotaoRetornarMenuMouseClicked
    ...
    private void BotãoRemoverDocentesDoSistemaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotãoRemoverDocentesDoSistemaActionPerformed
        ...
        if (TabelaRemoverDocentes.getSelectedRow() == -1) {
            ...
            if (escola.docentes.get(buffer.get(TabelaRemoverDocentes.getSelectedRow())).getDisciplinas().size() > 0) {
                JOptionPane.showMessageDialog(null, "Esse Docente está em uma discipilina. Vc nao pode remove-lo");
                return;
            }
            try {
    ...
    private void BarraDocentesTelaEditarDiscplinasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BarraDocentesTelaEditarDiscplinasActionPerformed
        if (isToListen) {
    ...
    }//GEN-LAST:event_BarraDocentesTelaEditarDiscplinasActionPerformed

    private void BarraAlunosTelaEditarDisciplinasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BarraAlunosTelaEditarDisciplinasActionPerformed
        if (isToListen) {
            String[] buffer = new String[1];
    ...
    }//GEN-LAST:event_BarraAlunosTelaEditarDisciplinasActionPerformed

    private void BarraAlunosCadastradosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BarraAlunosCadastradosActionPerformed
    ...
    }//GEN-LAST:event_BarraAlunosCadastradosActionPerformed

    private void BarraDocentesCadastradosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BarraDocentesCadastradosActionPerformed
        if (isToListen) {
            String buffer = (String) BarraAlunosCadastradosAlunos.getSelectedItem();
            Docente d = escola.docentes.get(Integer.parseInt(Character.toString(buffer.charAt(0))));
            CaixaDeTextoEditarDataNascDocente.setText(d.getDataNascimento());
            CaixaDeTextoNomeDocenteEditado.setText(d.getNome());
            EditarDocentesMatricula.setText(d.getMatricula());
        }
    }//GEN-LAST:event_BarraDocentesCadastradosActionPerformed

    private void BotaoRemoverCoisasDaDisciplinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoRemoverCoisasDaDisciplinaActionPerformed
        DefaultTableModel dtm = (DefaultTableModel) TabelaEditarDisciplinasAluno.getModel();
...
// =0 tabela vazia =1 um item selecionado =-1 nenhum item selecionado
        ...
        TabelaEditarDisciplinasAluno.setModel(dtm);
    }//GEN-LAST:event_BotaoRemoverCoisasDaDisciplinaActionPerformed

    private void BotaoSalvarEditacaoAlunoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoSalvarEditacaoAlunoActionPerformed
    ...
    }//GEN-LAST:event_BotaoSalvarEditacaoAlunoActionPerformed

    private void BotaoGerarRelatorioDocentesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoGerarRelatorioDocentesActionPerformed
    ...
    }//GEN-LAST:event_BotaoGerarRelatorioDocentesActionPerformed

    private void BotaoGerarRelatorioAlunosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoGerarRelatorioAlunosActionPerformed
    ...
    }//GEN-LAST:event_BotaoGerarRelatorioAlunosActionPerformed

    private void RefreshEditarTurmas(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RefreshEditarTurmas
        isToListen = false;
        ...
        isToListen = true;
    }//GEN-LAST:event_RefreshEditarTurmas

    private void BarraAlunosCadastradosTurmasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BarraAlunosCadastradosTurmasActionPerformed
    ...
    }//GEN-LAST:event_BarraAlunosCadastradosTurmasActionPerformed
...
//TODO #26 sair botando selectedIndex = -1 quando sair da ela nessas barra td
    ...
    private javax.swing.JLabel BotaoRetornarMenu;
